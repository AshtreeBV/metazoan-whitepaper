...
The Main Token is backed by an intrinsic value of Php 1.00 or $0.02, using assets in the [Treasury](architecture/treasury.md). The term backed means that token price will never fall below its intrinsic value (price floor of Php 1.00) while its upside potential is unlimited (no price ceiling).
